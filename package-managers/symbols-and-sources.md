...
![SymbolServer URL in MyGet feed settings](assets/feedsettings_symbols_url.png)
...
![Visual Studio symbol server settings](assets/debug-options-2015.png)
...
![Browse NuGet source code on MyGet](assets/browse-sources.png)
...
![Does the assembly hash match](assets/assembly-pdb-match.png)
...
![Installing the SymbolSource Plugin in NuGet Package Explorer](assets/npe_plugins_symbolsource.png)
